...
class SetupCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(unit, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
              ],
            ),
          ],
        ),
    ...
    // --- NEU: DYNAMISCHE SHOCK ANZEIGE ---
    final isCoil = bike.availableParameters?.shockIsCoil == true;
    final shockValStr = isCoil ? _formatNum(setup.shockRate) : _formatNum(setup.shockPsi);
    final shockUnitStr = isCoil ? 'lbs/in' : 'PSI';
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      color: setup.isFavorite ? Colors.amber : colorScheme.onSurfaceVariant,
                    ),
              ...
              Row(
                ...
                children: [
                  buildValueBox('assets/icons/fork.svg', 'Gabel', _formatNum(setup.forkPsi), 'PSI'),
                  const SizedBox(width: 12),
                  // Setzt den korrekten String & Einheit ein
                  buildValueBox('assets/icons/shock.svg', 'Dämpfer', shockValStr, shockUnitStr),
                  const Spacer(),
                  Row(
                    children: [
