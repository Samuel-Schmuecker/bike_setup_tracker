...
class TrailSetup {
  ...
  TrailSetup copyWith({
    ...
    return TrailSetup(
      ...
      forkLsr: forkLsr ?? this.forkLsr,
      forkTokens: forkTokens ?? this.forkTokens,
      forkHbo: forkHbo ?? this.forkHbo,
      shockPsi: shockPsi ?? this.shockPsi,
      shockTokens: shockTokens ?? this.shockTokens,
      shockRate: shockRate ?? this.shockRate,
      shockPreload: shockPreload ?? this.shockPreload,
      shockHsc: shockHsc ?? this.shockHsc,
      shockLsc: shockLsc ?? this.shockLsc,
      shockHsr: shockHsr ?? this.shockHsr,
      shockLsr: shockLsr ?? this.shockLsr,
  ...
  factory TrailSetup.fromMap(Map<String, dynamic> map) {
    return TrailSetup(
      id: map['id'] ?? '',
      name: map['name'] ?? '',
      fieldOrders: (map['fieldOrders'] as Map? ?? const {}).map(
        (key, value) => MapEntry(
          key.toString(),
      ...
      forkLsr: (map['forkLsr'] as num?)?.toInt(),
      forkTokens: (map['forkTokens'] as num?)?.toInt(),
      forkHbo: (map['forkHbo'] as num?)?.toInt(),
      shockPsi: (map['shockPsi'] as num?)?.toDouble(),
      shockTokens: (map['shockTokens'] as num?)?.toInt(),
      shockRate: (map['shockRate'] as num?)?.toDouble(),
      shockPreload: (map['shockPreload'] as num?)?.toDouble(),
      shockHsc: (map['shockHsc'] as num?)?.toInt(),
      shockLsc: (map['shockLsc'] as num?)?.toInt(),
      shockHsr: (map['shockHsr'] as num?)?.toInt(),
      shockLsr: (map['shockLsr'] as num?)?.toInt(),
      shockHbo: (map['shockHbo'] as num?)?.toInt(),
      frontTire: map['frontTire'] as String?,
      frontPressure: (map['frontPressure'] as num?)?.toDouble(),
      rearTire: map['rearTire'] as String?,
      rearPressure: (map['rearPressure'] as num?)?.toDouble(),
      notes: map['notes'] ?? '',
